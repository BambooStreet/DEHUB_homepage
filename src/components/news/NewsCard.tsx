...
export default function NewsCard({ item }: { item: NewsItem }) {
  return (
    <article className="p-6 bg-white rounded-xl border border-secondary-100 hover:border-primary-300 hover:shadow-sm transition-all">
      ...
      <p className="text-sm text-secondary-500 leading-relaxed">{item.content}</p>
    </article>
  );
}
